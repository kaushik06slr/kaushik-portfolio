...
function MagneticSocialLink({
  ...
  return (
    <Magnetic springOptions={{ bounce: 0 }} intensity={0}>
      <a
        href={link}
        className="group relative inline-flex shrink-0 items-center gap-[1px] rounded-full bg-zinc-100 p-2.5 py-1 text-sm text-black transition-colors duration-200 dark:bg-zinc-800 dark:text-zinc-100 hover:text-zinc-100 social-link"
      >
        {children}
        <svg
          width="15"
